...
```bash
git clone https://github.com/jplaulau14/warlord.git
cd warlord
...
./hwprobe/hwprobe.py scan

# Individual subsystems
./hwprobe/hwprobe.py cpu
./hwprobe/hwprobe.py gpu
./hwprobe/hwprobe.py pcie
./hwprobe/hwprobe.py score

# JSON output (works with any subcommand, useful for piping)
./hwprobe/hwprobe.py scan --json
./hwprobe/hwprobe.py gpu --json
```
